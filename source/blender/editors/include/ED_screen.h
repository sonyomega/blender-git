...
struct ScrArea *ED_screen_maximize_toggle(struct bContext *C, struct wmWindow *win, struct ScrArea *sa);
struct ScrArea *ED_screen_fullscreen_toggle(struct bContext *C, struct wmWindow *win, struct ScrArea *sa);
